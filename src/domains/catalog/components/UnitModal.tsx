...
import { Unit, UnitInput } from '../types/catalog';
...
export default function UnitModal({ isOpen, onClose, onSubmit, initialData }: Props) {
      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="is_active_unit" className="text-sm text-gray-700 dark:text-gray-300">Active</label>
          </div>
